...
# Modified to post captured images to Twitter by Gareth Halfacree
...
def saveImage(settings, width, height, quality, diskSpaceToReserve):
    ...
    twitter.update_status_with_media(status='Motion detected!', media=photo)
    print "Image posted to Twitter."
    sleep(60)
